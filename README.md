...
## __Input__ _(see example files in input folder)_

### __Maps__

__Land use map (required)__ *"land_use.asc"*
...
__Patch ID map (optional)__ *"patch_IDmap_eachcell_constraint.asc"*
...
__Transition matrix__ *"transition_matrix.txt"*
