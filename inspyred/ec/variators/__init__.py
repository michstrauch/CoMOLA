...
from inspyred.ec.variators.mutators import filter_mutation
from inspyred.ec.variators.mutators import repair_mutation
...
__all__ = ['default_variation',
           ...
           'nonuniform_mutation', 'random_reset_mutation', 'scramble_mutation', 'filter_mutation', 'repair_mutation']
